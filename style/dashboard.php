...
// Generate last 7 days array (including today)
$last7Days = [];
...
$sql_total_bought_price = "SELECT SUM(price) AS total_bought_price 
                           FROM pig_sell_requests 
                           WHERE status = 'accepted' 
                           AND is_processed = 1
                           AND processed_at BETWEEN '$date_from' AND '$date_to'";

$result_total_bought_price = $conn->query($sql_total_bought_price);
...
<body>
    ...
    <div class="content">
        <h1>Dashboard</h1>
            ...
            <input type="text" id="date_from" name="date_from" value="<?php echo $date_from; ?>" class="date-picker">
            <label for="date_to">Date To:</label>
            <input type="text" id="date_to" name="date_to" value="<?php echo $date_to; ?>" class="date-picker">
...
<!-- Dashboard Grid with Summary Cards -->
...
<div id="netProfitModal" class="modal">
    <div class="modal-content">
        ...
        <p>Total Buchers Fee: ₱<?php echo number_format(500 * $total_bought_pigs, 2); ?></p>
...
<div id="totalBoughtPriceModal" class="modal">
    <div class="modal-content">
        ...
        <table>
            ...
            <tbody>
                <?php
$sql_bought_price_details = "SELECT u.firstname, u.lastname, psr.batch_number, psr.price, psr.processed_at 
                             FROM pig_sell_requests psr
                             JOIN pig_survey ps ON psr.survey_id = ps.id
                             JOIN user u ON ps.userid = u.userID
                             WHERE psr.status = 'accepted'
